					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Manage your Appartments",
									"targetURL": "#appartments-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"appartments-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=appartments",
									"url": sap.ui.require.toUrl("appartments")
								}
							}
						}
					}
